...
def genPrompt(user, with_interests, type, lyrics='', sound=None, plugin=None, scale=None, skill=None, genre='', mood='', title=''):
    ...
    if type == "generateCover":
        return "Cover art for a song titled '" + title + "' having a genre of " + genre + " and a " + mood + " mood."
