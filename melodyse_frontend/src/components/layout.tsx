...
export default function Layout({
  ...
  useEffect(() => {
    router.asPath == "/"
      ? setSelected("home")
      : router.asPath == "/listen"
      ? setSelected("listen")
      : router.asPath == "/collab"
      ? setSelected("collab")
      : router.asPath == "/assistant"
          ...
          <nav className={styles.navBar}>
            <div className={styles.navBtnDiv}>
              <button
                type="button"
                className={
                  selected == "home" ? styles.navBtnFocus : styles.navBtn
                }
                onClick={() => switchPage("")}
              >
                HOME
              ...
              <button
                type="button"
                className={
                  selected == "listen" ? styles.navBtnFocus : styles.navBtn
                }
                onClick={() => switchPage("listen")}
              >
                LISTEN
              </button>
              ...
              <button
                type="button"
                className={
                  selected == "collab" ? styles.navBtnFocus : styles.navBtn
                }
              ...
              <button
                type="button"
                className={
                  selected == "assistant" ? styles.navBtnFocus : styles.navBtn
                }
                onClick={() => switchPage("assistant")}
              >
                ASSISTANT
              </button>
              ...
              <button
                type="button"
                className={
                  selected == "about" ? styles.navBtnFocus : styles.navBtn
                }
