...
export default function EndProject({ project, close }) {
  ...
  const endproject = () => {
    ...
    axios
      .post(`${process.env.SITE_URL}/endproject`, data, {
  ...
  const handleUpload = (e) => {
    ...
    axios
      .post(`${process.env.SITE_URL}/uploadproject`, data, {
        withCredentials: true,
      })
      .then((res) => {
        router.push("/");
        ...
        {!project.is_collab && (
          <>
            ...
            <div className={styles.inputDiv}>
              <span>
                Are you sure you want to end this project? You won't be able to
                access it after it ends.
              </span>
            ...
            >
              UPLOAD SONG, PAY AND END PROJECT
            </button>
            <input
              id="song-upload"
              type="file"
