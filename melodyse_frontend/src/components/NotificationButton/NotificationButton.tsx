...
export default function NotificationButton(props: any) {
  ...
  const getNotfs = () => {
    axios
      .get(`${process.env.SITE_URL}/getnotifications`, {
          ...
          <div className={styles.notificationsContainer}>
            ...
            {notifications ? (
              notifications.map((notf) => (
                <div
                  className={notf.is_read ? styles.notfRead : styles.notfUnread}
                  onClick={() => {
                    setDropdownOpen(false);
                ...
                >
                  ...
                  {notf.target_user_pic && (
                    <img src={process.env.SITE_URL + notf.target_user_pic} />
                  )}
                  {notf.project_pic && (
                    <img src={process.env.SITE_URL + notf.project_pic} />
                  )}
                </div>
              ))
            ) : (
              <span className={styles.noNotf}>
