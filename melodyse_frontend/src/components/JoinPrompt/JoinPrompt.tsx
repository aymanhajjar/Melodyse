...
export default function JoinPrompt({ close, project }) {
    ...
    const sendInvite = () => {
        ...
        axios.post(`${process.env.SITE_URL}/join-request`, data, {
    ...
    <div className={styles.hireContainer}>
            ...
            <div className={styles.inputDiv}>
                ...
                <textarea placeholder={'Message...'} value={messageVal} onChange={(e) => setMessageVal(e.target.value)}/>
            </div>
            <button type='button' className={styles.sendBtnHire} onClick={() => sendInvite()}>SEND REQUEST</button>
