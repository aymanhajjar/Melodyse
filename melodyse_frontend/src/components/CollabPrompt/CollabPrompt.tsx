...
export default function CollabPrompt({
  type,
  name = null,
  username = null,
  first_name = null,
  ...
  const sendInvite = (type) => {
    ...
    axios
      .post(`${process.env.SITE_URL}/send-invite`, data, {
  ...
  return (
    <>
      <div
        className={
          type == "hire" || "hireInvite"
            ? styles.hireContainer
            : styles.collabContainer
        }
      >
        {type == "hire" && (
          <>
            ...
            <div className={styles.inputDiv}>
              ...
              <input
                ...
                value={prjNameVal}
                onChange={(e) => setPrjNameVal(e.target.value)}
              />
            </div>
            <div className={styles.inputDiv}>
              ...
              <textarea
                ...
                value={prjDescVal}
                onChange={(e) => setPrjDescVal(e.target.value)}
              />
            </div>
            <div className={styles.payDiv}>
              ...
              <input
                type="number"
                placeholder="0.00"
                value={offeredAmountVal}
                onChange={(e) => setOfferedAmountVal(e.target.value)}
              />
            </div>
            <div className={styles.inputDiv}>
              <label>
        ...
        {type == "collab" && (
          <>
            ...
            <button
              type="button"
              className={styles.sendBtnCollab}
              onClick={() => sendInvite("collab")}
            >
              SEND INVITE
            </button>
            <div className={styles.close} onClick={close}>
          ...
          <>
            ...
            <div className={styles.inputDivSearch}>
              ...
              <input
                ...
                value={usernameHireVal}
                onChange={(e) => setUsernameHireVal(e.target.value)}
              />
            </div>
            <div className={styles.payDiv}>
              <label>Offered Amout:</label>
