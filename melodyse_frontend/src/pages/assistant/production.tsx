...
function Production() {
  ...
  const buildSound = () => {
    if (soundValue.length > 0) {
      ...
      axios
        .post(`${process.env.SITE_URL}/buildsound`, data, {
  ...
  const findBassline = () => {
    if (scale.length > 0) {
      ...
      axios
        .post(`${process.env.SITE_URL}/findbass`, data, {
          withCredentials: true,
        })
        .then((res) => {
          ...
          <div className={styles.DIV2}>
            <div className={styles.scalesNotes}>
              ...
              <div>
                <h4>Scale(s): </h4>
                {scale.length > 0
                  ? scale.slice(0, 2).join(", ")
                  : "Select notes to show scales"}
              </div>
              <div>
                ...
                <div className={styles.chords}>
                  {chords.length > 0
                    ? chords.map((chord) => (
                        <ChordCard
                          chord={chord}
                          select={(chord) => handleChord(chord)}
          ...
          <div className={styles.DIV3}>
            <div className={styles.soundLab}>
              ...
              <div className={styles.inputGroup}>
                ...
                <input
                  placeholder="Synth used in A Sky Full Of Stars..."
                  value={soundValue}
              ...
              <div className={styles.inputGroup}>
                ...
                <input
                  placeholder="Sylenth1, Serum, Nexus, Massive..."
                  value={pluginValue}
