      ...
      <div className={styles.container} ref={container}>
        <div className={styles.navDots}>
          {sections.map(({ id }) => (
            <button
              key={id}
              className={
                id === activeSection ? styles.dotActive : styles.dotInactive
              }
        ...
        <section ref={sections[0].ref} id={sections[0].id}>
          ...
          <div className={styles.textSectionLeft}>
            <h1>
              STREAMLINE YOUR MUSIC JOURNEY WITH{" "}
              <span className={styles.redHeadline}>EASE</span>
            </h1>
            <p>
              Collaborate with Musicians Worldwide: Find the Perfect Match for
        ...
        <section ref={sections[1].ref} id={sections[1].id}>
          ...
          <div className={styles.textSectionLeft}>
            <h1>
              DISCOVER THE <br />
              <span className={styles.redHeadline}>HOTTEST</span> <br />
              NEW <span className={styles.redHeadline}>MUSIC</span>
            </h1>
        ...
        <section ref={sections[2].ref} id={sections[2].id}>
          ...
          <div className={styles.textSectionTop}>
            <h1>
              CONNECT WITH YOUR MUSICAL DREAM{" "}
              <span className={styles.redHeadline}>TEAM</span>
            </h1>
            <p>
              Find Your Perfect Musical Match! Organize Your Team and Assign
              Tasks with Ease. Chat, Share Files, and Make Payments
            </p>
        ...
        <section ref={sections[3].ref} id={sections[3].id}>
          ...
          <div className={styles.textSectionLeft}>
            <h1>
              REVOLUTIONIZE YOUR MUSIC WITH{" "}
              <span className={styles.redHeadline}>AI</span>
            </h1>
